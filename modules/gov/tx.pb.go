...
type MsgSubmitProposal struct {
	...
	InitialDeposit plugchain_sdk_types.Coins `protobuf:"bytes,2,rep,name=initial_deposit,json=initialDeposit,proto3,castrepeated=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Coins" json:"initial_deposit" yaml:"initial_deposit"`
