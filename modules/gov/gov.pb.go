...
type Deposit struct {
	...
	Amount     plugchain_sdk_types.Coins `protobuf:"bytes,3,rep,name=amount,proto3,castrepeated=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Coins" json:"amount"`
}
...
type Proposal struct {
	...
	TotalDeposit     plugchain_sdk_types.Coins `protobuf:"bytes,7,rep,name=total_deposit,json=totalDeposit,proto3,castrepeated=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Coins" json:"total_deposit" yaml:"total_deposit"`
...
type TallyResult struct {
	Yes        plugchain_sdk_types.Int `protobuf:"bytes,1,opt,name=yes,proto3,customtype=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Int" json:"yes"`
	Abstain    plugchain_sdk_types.Int `protobuf:"bytes,2,opt,name=abstain,proto3,customtype=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Int" json:"abstain"`
	No         plugchain_sdk_types.Int `protobuf:"bytes,3,opt,name=no,proto3,customtype=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Int" json:"no"`
	NoWithVeto plugchain_sdk_types.Int `protobuf:"bytes,4,opt,name=no_with_veto,json=noWithVeto,proto3,customtype=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Int" json:"no_with_veto" yaml:"no_with_veto"`
}
...
type DepositParams struct {
	...
	MinDeposit plugchain_sdk_types.Coins `protobuf:"bytes,1,rep,name=min_deposit,json=minDeposit,proto3,castrepeated=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Coins" json:"min_deposit,omitempty" yaml:"min_deposit"`
