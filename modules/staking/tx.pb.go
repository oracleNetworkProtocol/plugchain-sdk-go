...
import (
	...
	types1 "github.com/oracleNetworkProtocol/plugchain-sdk-go/types"
	time "time"
)
...
type MsgCreateValidator struct {
	...
	MinSelfDelegation plugchain_sdk_go_types.Int `protobuf:"bytes,3,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Int" json:"min_self_delegation" yaml:"min_self_delegation"`
...
type MsgEditValidator struct {
	...
	//
	// REF: #2373
	CommissionRate    *plugchain_sdk_go_types.Dec `protobuf:"bytes,3,opt,name=commission_rate,json=commissionRate,proto3,customtype=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Dec" json:"commission_rate,omitempty" yaml:"commission_rate"`
	MinSelfDelegation *plugchain_sdk_go_types.Int `protobuf:"bytes,4,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Int" json:"min_self_delegation,omitempty" yaml:"min_self_delegation"`
}
...
func (m *MsgEditValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			var v plugchain_sdk_go_types.Dec
			m.CommissionRate = &v
		...
		case 4:
			...
			var v plugchain_sdk_go_types.Int
