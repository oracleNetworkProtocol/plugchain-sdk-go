...
type QueryFeesResponse struct {
	...
	IssueFee plugchain_sdk_go_types.Coin `protobuf:"bytes,2,opt,name=issue_fee,json=issueFee,proto3,casttype=plugchain-sdk-go/types.Coin" json:"issue_fee" yaml:"issue_fee"`
	MintFee  plugchain_sdk_go_types.Coin `protobuf:"bytes,3,opt,name=mint_fee,json=mintFee,proto3,casttype=plugchain-sdk-go/types.Coin" json:"mint_fee" yaml:"mint_fee"`
}
...
func (m *QueryFeesResponse) GetIssueFee() plugchain_sdk_go_types.Coin {
	if m != nil {
		return m.IssueFee
	}
	return plugchain_sdk_go_types.Coin{}
}

func (m *QueryFeesResponse) GetMintFee() plugchain_sdk_go_types.Coin {
	if m != nil {
		return m.MintFee
	}
	return plugchain_sdk_go_types.Coin{}
...
var fileDescriptor_ec043bcd18c4056e = []byte{
	...
	,
}
