...
import (
	...
	github_com_oracleNetworkProtocol_sdk_types "github.com/oracleNetworkProtocol/plugchain-sdk-go/types"
...
type QueryBaseFeeResponse struct {
	BaseFee *github_com_oracleNetworkProtocol_sdk_types.Int `protobuf:"bytes,1,opt,name=base_fee,json=baseFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"base_fee,omitempty"`
}
...
func (m *QueryBaseFeeResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v github_com_oracleNetworkProtocol_sdk_types.Int
			m.BaseFee = &v
