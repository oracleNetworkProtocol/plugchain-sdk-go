...
type Params struct {
	...
	BaseFee github_com_oracleNetworkProtocol_plugchain_sdk_go_types.Int `protobuf:"bytes,6,opt,name=base_fee,json=baseFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"base_fee"`
	// min_gas_price defines the minimum gas price value for cosmos and eth transactions
	MinGasPrice github_com_oracleNetworkProtocol_plugchain_sdk_go_types.Dec `protobuf:"bytes,7,opt,name=min_gas_price,json=minGasPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_gas_price"`
	// min gas denominator bounds the minimum gasUsed to be charged
	// to senders based on GasLimit
	MinGasMultiplier github_com_oracleNetworkProtocol_plugchain_sdk_go_types.Dec `protobuf:"bytes,8,opt,name=min_gas_multiplier,json=minGasMultiplier,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_gas_multiplier"`
}
