...
type GenesisState struct {
	...
	// Zero by default.
	BaseFee github_com_oracleNetworkProtocol_sdk_types.Int `protobuf:"bytes,2,opt,name=base_fee,json=baseFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"base_fee"`
