...
import (
	...
	types2 "github.com/oracleNetworkProtocol/plugchain-sdk-go/types"
	signing "github.com/oracleNetworkProtocol/plugchain-sdk-go/types/tx/signing"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type Fee struct {
	...
	Amount github_com_oracleNetworkProtocol_plugchain_sdk_go_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/oracleNetworkProtocol/plugchain-sdk-go/types.Coins" json:"amount"`
...
func (m *Fee) GetAmount() github_com_oracleNetworkProtocol_plugchain_sdk_go_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
var fileDescriptor_96d1575ffde80842 = []byte{
	...
	,
}
