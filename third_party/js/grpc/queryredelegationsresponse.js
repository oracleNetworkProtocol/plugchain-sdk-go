...
goog.provide('proto.cosmos.staking.v1beta1.QueryRedelegationsResponse');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.cosmos.base.query.v1beta1.PageResponse');
goog.require('proto.cosmos.staking.v1beta1.RedelegationResponse');
...
proto.cosmos.staking.v1beta1.QueryRedelegationsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.cosmos.staking.v1beta1.RedelegationResponse.toObject, includeInstance),
...
proto.cosmos.staking.v1beta1.QueryRedelegationsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.cosmos.staking.v1beta1.RedelegationResponse;
      reader.readMessage(value,proto.cosmos.staking.v1beta1.RedelegationResponse.deserializeBinaryFromReader);
...
proto.cosmos.staking.v1beta1.QueryRedelegationsResponse.prototype.getRedelegationResponsesList = function() {
  return /** @type{!Array<!proto.cosmos.staking.v1beta1.RedelegationResponse>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.cosmos.staking.v1beta1.RedelegationResponse, 1));
};
