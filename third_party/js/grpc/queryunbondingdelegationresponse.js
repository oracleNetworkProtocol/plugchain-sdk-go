...
goog.provide('proto.cosmos.staking.v1beta1.QueryUnbondingDelegationResponse');
...
proto.cosmos.staking.v1beta1.QueryUnbondingDelegationResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    unbond: (f = msg.getUnbond()) && proto.cosmos.staking.v1beta1.UnbondingDelegation.toObject(includeInstance, f)
  };
...
proto.cosmos.staking.v1beta1.QueryUnbondingDelegationResponse.prototype.getUnbond = function() {
  return /** @type{?proto.cosmos.staking.v1beta1.UnbondingDelegation} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.staking.v1beta1.UnbondingDelegation, 1));
};
