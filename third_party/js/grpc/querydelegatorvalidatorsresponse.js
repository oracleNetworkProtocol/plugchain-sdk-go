...
goog.provide('proto.cosmos.staking.v1beta1.QueryDelegatorValidatorsResponse');
...
proto.cosmos.staking.v1beta1.QueryDelegatorValidatorsResponse.prototype.getValidatorsList = function() {
  return /** @type{!Array<!proto.cosmos.staking.v1beta1.Validator>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.cosmos.staking.v1beta1.Validator, 1));
};
