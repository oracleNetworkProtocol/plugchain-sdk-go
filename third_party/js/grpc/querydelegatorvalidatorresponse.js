...
goog.provide('proto.cosmos.staking.v1beta1.QueryDelegatorValidatorResponse');
...
proto.cosmos.staking.v1beta1.QueryDelegatorValidatorResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    validator: (f = msg.getValidator()) && proto.cosmos.staking.v1beta1.Validator.toObject(includeInstance, f)
  };
...
proto.cosmos.staking.v1beta1.QueryDelegatorValidatorResponse.prototype.getValidator = function() {
  return /** @type{?proto.cosmos.staking.v1beta1.Validator} */ (
    jspb.Message.getWrapperField(this, proto.cosmos.staking.v1beta1.Validator, 1));
};
