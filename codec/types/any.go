...
// [DEPRECATED]: should be moved away: https://github.com/oracleNetworkProtocol/plugchain-sdk-go/issues/7479
func PackAny(x interface{}) (*Any, error) {
	...
	if !ok {
		return nil, fmt.Errorf("Expecting %T to implement proto.Message", x)
	}
